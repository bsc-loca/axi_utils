...
```
cd existing_repo
git remote add origin https://gitlab.bsc.es/jdeharor/axi_utils.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bsc.es/jdeharor/axi_utils/-/settings/integrations)
